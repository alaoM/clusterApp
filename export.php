...
$query = "SELECT * FROM users where clusterCode = '".$_SESSION['clusterCode']."' ORDER BY id ASC";
...
if (isset($_POST["export"])) {
  ...
  $active_sheet->setCellValue('I1', 'Town');
  ...
  foreach ($result as $row) {
    ...
    $active_sheet->setCellValue('I' . $count, $row["Town"]);
