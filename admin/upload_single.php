...
if(!$user->admin_is_logged_in()){ header('Location: admin.php'); } 
...
if (isset($_POST['submit'])) {
    ...
    if (!isset($error)) {
        ...
        try {
            ...
            $stmt = $db->prepare('INSERT INTO users (fullName,Age,Gender,BankName,AccountNumber, BVN, PhoneNumber, State, Project,Amount) VALUES (:fullName,:Age,:Gender,:BankName,:AccountNumber, :BVN, :PhoneNumber, :State, :Project,:Amount)');
            $stmt->execute(array(
...
<?php include('includes/navbar.html'); ?>
    ...
    <h2 style="padding-left: 100px; padding-bottom:30px;">Import Single Record</h2>
        ...
        <form id="search_form" class="search_form" method="post" action="" name="registration">
            ...
            <div><input class='input_field' type="text" placeholder="State" name="State"></div>
